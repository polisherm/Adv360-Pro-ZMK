...
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="keymap-drawer/adv360-dark.svg">
  <img alt="my_keymap" src="keymap-drawer/adv360-light.svg">
</picture>

> This image is auto-generated by GitHub Actions whenever `config/adv360.keymap` changes. Light and dark variants are emitted so the rendering follows the GitHub theme. See [`keymap-drawer/README.md`](keymap-drawer/README.md) for the pipeline details.
